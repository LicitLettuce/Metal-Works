    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(ModBlocks.TIN_ORE.get(),
                        ...
                        ModBlocks.ERODED_TIN.get(),
                        ModBlocks.WAXED_TIN_BLOCK.get(),
                        ModBlocks.WAXED_TARNISHED_TIN.get(),
                        ModBlocks.WAXED_CORRODED_TIN.get(),
                        ModBlocks.WAXED_ERODED_TIN.get(),
                        ModBlocks.CHISELED_TIN.get(),
                        ModBlocks.TARNISHED_CHISELED_TIN.get(),
                        ModBlocks.CORRODED_CHISELED_TIN.get(),
                        ModBlocks.ERODED_CHISELED_TIN.get(),
                        ModBlocks.WAXED_CHISELED_TIN.get(),
                        ModBlocks.WAXED_TARNISHED_CHISELED_TIN.get(),
                        ModBlocks.WAXED_CORRODED_CHISELED_TIN.get(),
                        ModBlocks.WAXED_ERODED_CHISELED_TIN.get(),
                        ModBlocks.TIN_GRATE.get(),
                        ModBlocks.TARNISHED_TIN_GRATE.get(),
                        ModBlocks.CORRODED_TIN_GRATE.get(),
                        ModBlocks.ERODED_TIN_GRATE.get(),
                        ModBlocks.WAXED_TIN_GRATE.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_GRATE.get(),
                        ModBlocks.WAXED_CORRODED_TIN_GRATE.get(),
                        ModBlocks.WAXED_ERODED_TIN_GRATE.get(),
                        ModBlocks.TIN_GRATE_DRAIN.get(),
                        ModBlocks.TARNISHED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.CORRODED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.ERODED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.WAXED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.WAXED_CORRODED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.WAXED_ERODED_TIN_GRATE_DRAIN.get(),
                        ModBlocks.CUT_TIN.get(),
                        ModBlocks.TARNISHED_CUT_TIN.get(),
                        ModBlocks.CORRODED_CUT_TIN.get(),
                        ModBlocks.ERODED_CUT_TIN.get(),
                        ModBlocks.WAXED_CUT_TIN.get(),
                        ModBlocks.WAXED_TARNISHED_CUT_TIN.get(),
                        ModBlocks.WAXED_CORRODED_CUT_TIN.get(),
                        ModBlocks.WAXED_ERODED_CUT_TIN.get(),
                        ModBlocks.TARNISHED_CUT_TIN_STAIRS.get(),
                        ModBlocks.CORRODED_CUT_TIN_STAIRS.get(),
                        ModBlocks.ERODED_CUT_TIN_STAIRS.get(),
                        ModBlocks.WAXED_CUT_TIN_STAIRS.get(),
                        ModBlocks.WAXED_TARNISHED_CUT_TIN_STAIRS.get(),
                        ModBlocks.WAXED_CORRODED_CUT_TIN_STAIRS.get(),
                        ModBlocks.WAXED_ERODED_CUT_TIN_STAIRS.get(),
                        ModBlocks.TARNISHED_CUT_TIN_SLAB.get(),
                        ModBlocks.CORRODED_CUT_TIN_SLAB.get(),
                        ModBlocks.ERODED_CUT_TIN_SLAB.get(),
                        ModBlocks.WAXED_CUT_TIN_SLAB.get(),
                        ModBlocks.WAXED_TARNISHED_CUT_TIN_SLAB.get(),
                        ModBlocks.WAXED_CORRODED_CUT_TIN_SLAB.get(),
                        ModBlocks.WAXED_ERODED_CUT_TIN_SLAB.get(),
                        ModBlocks.TIN_TILES.get(),
                        ModBlocks.TARNISHED_TIN_TILES.get(),
                        ModBlocks.CORRODED_TIN_TILES.get(),
                        ModBlocks.ERODED_TIN_TILES.get(),
                        ModBlocks.WAXED_TIN_TILES.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_TILES.get(),
                        ModBlocks.WAXED_CORRODED_TIN_TILES.get(),
                        ModBlocks.WAXED_ERODED_TIN_TILES.get(),
                        ModBlocks.TIN_TILE_STAIRS.get(),
                        ModBlocks.TARNISHED_TIN_TILE_STAIRS.get(),
                        ModBlocks.CORRODED_TIN_TILE_STAIRS.get(),
                        ModBlocks.ERODED_TIN_TILE_STAIRS.get(),
                        ModBlocks.WAXED_TIN_TILE_STAIRS.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_TILE_STAIRS.get(),
                        ModBlocks.WAXED_CORRODED_TIN_TILE_STAIRS.get(),
                        ModBlocks.WAXED_ERODED_TIN_TILE_STAIRS.get(),
                        ModBlocks.TIN_TILE_SLAB.get(),
                        ModBlocks.TARNISHED_TIN_TILE_SLAB.get(),
                        ModBlocks.CORRODED_TIN_TILE_SLAB.get(),
                        ModBlocks.ERODED_TIN_TILE_SLAB.get(),
                        ModBlocks.WAXED_TIN_TILE_SLAB.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_TILE_SLAB.get(),
                        ModBlocks.WAXED_CORRODED_TIN_TILE_SLAB.get(),
                        ModBlocks.WAXED_ERODED_TIN_TILE_SLAB.get(),
                        ModBlocks.TIN_SHINGLES.get(),
                        ModBlocks.TARNISHED_TIN_SHINGLES.get(),
                        ModBlocks.CORRODED_TIN_SHINGLES.get(),
                        ModBlocks.ERODED_TIN_SHINGLES.get(),
                        ModBlocks.WAXED_TIN_SHINGLES.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_SHINGLES.get(),
                        ModBlocks.WAXED_CORRODED_TIN_SHINGLES.get(),
                        ModBlocks.WAXED_ERODED_TIN_SHINGLES.get(),
                        ModBlocks.TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.TARNISHED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.CORRODED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.ERODED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.WAXED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.WAXED_CORRODED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.WAXED_ERODED_TIN_SHINGLE_STAIRS.get(),
                        ModBlocks.TIN_SHINGLE_SLAB.get(),
                        ModBlocks.TARNISHED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.CORRODED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.ERODED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.WAXED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.WAXED_CORRODED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.WAXED_ERODED_TIN_SHINGLE_SLAB.get(),
                        ModBlocks.TIN_DOOR.get(),
                        ModBlocks.TIN_TRAPDOOR.get(),
                        ModBlocks.TIN_BARS.get(),
                        ModBlocks.TARNISHED_TIN_BARS.get(),
                        ModBlocks.CORRODED_TIN_BARS.get(),
                        ModBlocks.ERODED_TIN_BARS.get(),
                        ModBlocks.WAXED_TIN_BARS.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_BARS.get(),
                        ModBlocks.WAXED_CORRODED_TIN_BARS.get(),
                        ModBlocks.WAXED_ERODED_TIN_BARS.get(),
                        ModBlocks.TIN_CHAIN.get(),
                        ModBlocks.TARNISHED_TIN_CHAIN.get(),
                        ModBlocks.CORRODED_TIN_CHAIN.get(),
                        ModBlocks.ERODED_TIN_CHAIN.get(),
                        ModBlocks.WAXED_TIN_CHAIN.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_CHAIN.get(),
                        ModBlocks.WAXED_CORRODED_TIN_CHAIN.get(),
                        ModBlocks.WAXED_ERODED_TIN_CHAIN.get(),
                        ModBlocks.TIN_LANTERN.get(),
                        ModBlocks.TARNISHED_TIN_LANTERN.get(),
                        ModBlocks.CORRODED_TIN_LANTERN.get(),
                        ModBlocks.ERODED_TIN_LANTERN.get(),
                        ModBlocks.WAXED_TIN_LANTERN.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_LANTERN.get(),
                        ModBlocks.WAXED_CORRODED_TIN_LANTERN.get(),
                        ModBlocks.WAXED_ERODED_TIN_LANTERN.get(),
                        ModBlocks.TIN_SOUL_LANTERN.get(),
                        ModBlocks.TARNISHED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.CORRODED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.ERODED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.WAXED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.WAXED_TARNISHED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.WAXED_CORRODED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.WAXED_ERODED_TIN_SOUL_LANTERN.get(),
                        ModBlocks.TIN_MAGE_LANTERN.get(),
                        ModBlocks.TARNISHED_TIN_MAGE_LANTERN.get(),
                        ModBlocks.CORRODED_TIN_MAGE_LANTERN.get(),
                        ModBlocks.ERODED_TIN_MAGE_LANTERN.get(),
                        ModBlocks.WAXED_TIN_MAGE_LANTERN.get(),
