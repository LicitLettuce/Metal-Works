...
public class ModAdvancementsGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries,
        ...
        Advancement waxedInInv = Advancement.Builder.advancement()
                ...
                .addCriterion("waxed_tarnished_tin_mage_lantern", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_TARNISHED_TIN_MAGE_LANTERN.get()))

                .addCriterion("waxed_corroded_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN.get()))
                .addCriterion("waxed_corroded_chiseled_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_CHISELED_TIN.get()))
                .addCriterion("waxed_corroded_grate", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_GRATE.get()))
                .addCriterion("waxed_corroded_grate_drain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_GRATE_DRAIN.get()))
                .addCriterion("waxed_corroded_cut", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_CUT_TIN.get()))
                .addCriterion("waxed_corroded_cut_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_CUT_TIN_STAIRS.get()))
                .addCriterion("waxed_corroded_cut_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_CUT_TIN_SLAB.get()))
                .addCriterion("waxed_corroded_tiles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_TILES.get()))
                .addCriterion("waxed_corroded_tile_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_TILE_STAIRS.get()))
                .addCriterion("waxed_corroded_tile_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_TILE_SLAB.get()))
                .addCriterion("waxed_corroded_shingles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_SHINGLES.get()))
                .addCriterion("waxed_corroded_shingle_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_SHINGLE_STAIRS.get()))
                .addCriterion("waxed_corroded_shingle_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_SHINGLE_SLAB.get()))
                .addCriterion("waxed_corroded_bars", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_BARS.get()))
                .addCriterion("waxed_corroded_chain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_CORRODED_TIN_CHAIN.get()))

                .addCriterion("waxed_eroded_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN.get()))
                .addCriterion("waxed_eroded_chiseled_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_CHISELED_TIN.get()))
                .addCriterion("waxed_eroded_grate", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_GRATE.get()))
                .addCriterion("waxed_eroded_grate_drain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_GRATE_DRAIN.get()))
                .addCriterion("waxed_eroded_cut", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_CUT_TIN.get()))
                .addCriterion("waxed_eroded_cut_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_CUT_TIN_STAIRS.get()))
                .addCriterion("waxed_eroded_cut_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_CUT_TIN_SLAB.get()))
                .addCriterion("waxed_eroded_tiles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_TILES.get()))
                .addCriterion("waxed_eroded_tile_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_TILE_STAIRS.get()))
                .addCriterion("waxed_eroded_tile_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_TILE_SLAB.get()))
                .addCriterion("waxed_eroded_shingles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_SHINGLES.get()))
                .addCriterion("waxed_eroded_shingle_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_SHINGLE_STAIRS.get()))
                .addCriterion("waxed_eroded_shingle_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_SHINGLE_SLAB.get()))
                .addCriterion("waxed_eroded_bars", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_BARS.get()))
                .addCriterion("waxed_eroded_chain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.WAXED_ERODED_TIN_CHAIN.get()))
        ...
        Advancement weatheredInInv = Advancement.Builder.advancement()
                ...
                .addCriterion("corroded_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN.get()))
                .addCriterion("corroded_chiseled_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_CHISELED_TIN.get()))
                .addCriterion("corroded_grate", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_GRATE.get()))
                .addCriterion("corroded_grate_drain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_GRATE_DRAIN.get()))
                .addCriterion("corroded_cut", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_CUT_TIN.get()))
                .addCriterion("corroded_cut_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_CUT_TIN_STAIRS.get()))
                .addCriterion("corroded_cut_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_CUT_TIN_SLAB.get()))
                .addCriterion("corroded_tiles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_TILES.get()))
                .addCriterion("corroded_tile_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_TILE_STAIRS.get()))
                .addCriterion("corroded_tile_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_TILE_SLAB.get()))
                .addCriterion("corroded_shingles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_SHINGLES.get()))
                .addCriterion("corroded_shingle_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_SHINGLE_STAIRS.get()))
                .addCriterion("corroded_shingle_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_SHINGLE_SLAB.get()))
                .addCriterion("corroded_bars", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_BARS.get()))
                .addCriterion("corroded_chain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CORRODED_TIN_CHAIN.get()))

                .addCriterion("eroded_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN.get()))
                .addCriterion("eroded_chiseled_tin", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_CHISELED_TIN.get()))
                .addCriterion("eroded_grate", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_GRATE.get()))
                .addCriterion("eroded_grate_drain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_GRATE_DRAIN.get()))
                .addCriterion("eroded_cut", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_CUT_TIN.get()))
                .addCriterion("eroded_cut_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_CUT_TIN_STAIRS.get()))
                .addCriterion("eroded_cut_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_CUT_TIN_SLAB.get()))
                .addCriterion("eroded_tiles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_TILES.get()))
                .addCriterion("eroded_tile_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_TILE_STAIRS.get()))
                .addCriterion("eroded_tile_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_TILE_SLAB.get()))
                .addCriterion("eroded_shingles", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_SHINGLES.get()))
                .addCriterion("eroded_shingle_stairs", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_SHINGLE_STAIRS.get()))
                .addCriterion("eroded_shingle_slab", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_SHINGLE_SLAB.get()))
                .addCriterion("eroded_bars", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_BARS.get()))
                .addCriterion("eroded_chain", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ERODED_TIN_CHAIN.get()))
                .requirements(RequirementsStrategy.OR)
