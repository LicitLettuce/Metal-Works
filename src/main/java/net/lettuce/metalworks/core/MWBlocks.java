...
import net.lettuce.metalworks.block.GrateBlock;
import net.lettuce.metalworks.block.GrateDrainBlock;
import net.lettuce.metalworks.block.TinLanternBlock;
...
public class MWBlocks {
    ...
    public static final RegistryObject<Block> RAW_TIN_BLOCK = BLOCKS.register("raw_tin_block", () -> new Block
            (BlockBehaviour.Properties.copy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    ...
    public static final RegistryObject<StairBlock> CUT_TIN_STAIRS = BLOCKS.register("cut_tin_stairs", () -> new StairBlock(() -> MWBlocks.CUT_TIN.get().defaultBlockState(), BlockBehaviour.Properties.copy
            (Blocks.CUT_COPPER)));
    ...
    public static final RegistryObject<ButtonBlock> CUT_TIN_BUTTON = BLOCKS.register("cut_tin_button", () -> new ButtonBlock
            (BlockBehaviour.Properties.copy(Blocks.STONE_BUTTON).sound(SoundType.COPPER), BlockSetType.STONE, 10, true));
    ...
    public static final RegistryObject<StairBlock> TIN_SHINGLE_STAIRS = BLOCKS.register("tin_shingle_stairs", () -> new StairBlock(() -> MWBlocks.TIN_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.copy
            (Blocks.CUT_COPPER)));
    ...
    public static final RegistryObject<Block> ROSE_LAMP = BLOCKS.register("rose_lamp", () -> new Block
