...
public class MWItems {
    ...
    public static final RegistryObject<BlockItem> CUT_TIN_WALL = ITEMS.register("cut_tin_wall", () -> new BlockItem
            (MWBlocks.CUT_TIN_WALL.get(), new Item.Properties()));

    public static final RegistryObject<BlockItem> CUT_TIN_BUTTON = ITEMS.register("cut_tin_button", () -> new BlockItem
            (MWBlocks.CUT_TIN_BUTTON.get(), new Item.Properties()));

    public static final RegistryObject<BlockItem> CUT_TIN_PRESSURE_PLATE = ITEMS.register("cut_tin_pressure_plate", () -> new BlockItem
            (MWBlocks.CUT_TIN_PRESSURE_PLATE.get(), new Item.Properties()));
    ...
    public static final RegistryObject<SwordItem> TIN_SWORD = ITEMS.register("tin_sword", () -> new SwordItem
            (MWToolTiers.TIN, 3 ,-2.0F, new Item.Properties()));

    public static final RegistryObject<PickaxeItem> TIN_PICKAXE = ITEMS.register("tin_pickaxe", () -> new PickaxeItem
            (MWToolTiers.TIN, 1, -2.4F, new Item.Properties()));

    public static final RegistryObject<AxeItem> TIN_AXE = ITEMS.register("tin_axe", () -> new AxeItem
            (MWToolTiers.TIN,  6.5F, -2.7F, new Item.Properties()));

    public static final RegistryObject<ShovelItem> TIN_SHOVEL = ITEMS.register("tin_shovel", () -> new ShovelItem
            (MWToolTiers.TIN,1.5F, -2.6F, new Item.Properties()));

    public static final RegistryObject<HoeItem> TIN_HOE = ITEMS.register("tin_hoe", () -> new HoeItem
            (MWToolTiers.TIN, -2, -0.6F, new Item.Properties()));

    public static final RegistryObject<ArmorItem> TIN_HELMET = ITEMS.register("tin_helmet", () -> new ArmorItem
            (MWArmorMaterials.TIN, ArmorItem.Type.HELMET, new Item.Properties()));

    public static final RegistryObject<ArmorItem> TIN_CHESTPLATE = ITEMS.register("tin_chestplate", () -> new ArmorItem
            (MWArmorMaterials.TIN, ArmorItem.Type.CHESTPLATE, new Item.Properties()));

    public static final RegistryObject<ArmorItem> TIN_LEGGINGS = ITEMS.register("tin_leggings", () -> new ArmorItem
            (MWArmorMaterials.TIN, ArmorItem.Type.LEGGINGS, new Item.Properties()));

    public static final RegistryObject<ArmorItem> TIN_BOOTS = ITEMS.register("tin_boots", () -> new ArmorItem
    ...
    public static final RegistryObject<SwordItem> BRONZE_SWORD = ITEMS.register("bronze_sword", () -> new SwordItem
            (MWToolTiers.BRONZE,3,-2.4F, new Item.Properties().fireResistant()));

    public static final RegistryObject<PickaxeItem> BRONZE_PICKAXE = ITEMS.register("bronze_pickaxe", () -> new PickaxeItem
            (MWToolTiers.BRONZE,1,-2.8F, new Item.Properties().fireResistant()));

    public static final RegistryObject<AxeItem> BRONZE_AXE = ITEMS.register("bronze_axe", () -> new AxeItem
            (MWToolTiers.BRONZE, 6, -3.1F, new Item.Properties().fireResistant()));

    public static final RegistryObject<ShovelItem> BRONZE_SHOVEL = ITEMS.register("bronze_shovel", () -> new ShovelItem
            (MWToolTiers.BRONZE, 1.5F, -3.0F, new Item.Properties().fireResistant()));

    public static final RegistryObject<HoeItem> BRONZE_HOE = ITEMS.register("bronze_hoe", () -> new HoeItem
            (MWToolTiers.BRONZE, -2,-1, new Item.Properties().fireResistant()));

    public static final RegistryObject<HorseArmorItem> BRONZE_HORSE_ARMOR = ITEMS.register
            ("bronze_horse_armor", () -> new HorseArmorItem( 9,"bronze", new Item.Properties().stacksTo(1).fireResistant()));

    public static final RegistryObject<ShearsItem> BRONZE_SHEARS = ITEMS.register("bronze_shears", () -> new ShearsItem
            (new Item.Properties().stacksTo(1).durability(964).fireResistant()));

    public static final RegistryObject<ArmorItem> BRONZE_HELMET = ITEMS.register("bronze_helmet", () -> new ArmorItem
            (MWArmorMaterials.BRONZE, ArmorItem.Type.HELMET, new Item.Properties().fireResistant()));

    public static final RegistryObject<ArmorItem> BRONZE_CHESTPLATE = ITEMS.register("bronze_chestplate", () -> new ArmorItem
            (MWArmorMaterials.BRONZE, ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant()));

    public static final RegistryObject<ArmorItem> BRONZE_LEGGINGS = ITEMS.register("bronze_leggings", () -> new ArmorItem
            (MWArmorMaterials.BRONZE, ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant()));

    public static final RegistryObject<ArmorItem> BRONZE_BOOTS = ITEMS.register("bronze_boots", () -> new ArmorItem
    ...
    public static final RegistryObject<BlockItem> ROSE_LAMP = ITEMS.register("rose_lamp", () -> new BlockItem
            (MWBlocks.ROSE_LAMP.get(), new Item.Properties()));
    ...
    public static final RegistryObject<SwordItem> ROSE_GOLD_SWORD = ITEMS.register("rose_gold_sword", () -> new SwordItem
            (MWToolTiers.ROSE_GOLD, 3 ,-2.4F, new Item.Properties()));

    public static final RegistryObject<PickaxeItem> ROSE_GOLD_PICKAXE = ITEMS.register("rose_gold_pickaxe", () -> new PickaxeItem
            (MWToolTiers.ROSE_GOLD, 1, -2.8F, new Item.Properties()));

    public static final RegistryObject<AxeItem> ROSE_GOLD_AXE = ITEMS.register("rose_gold_axe", () -> new AxeItem
            (MWToolTiers.ROSE_GOLD, 6, -3.1F, new Item.Properties()));

    public static final RegistryObject<ShovelItem> ROSE_GOLD_SHOVEl = ITEMS.register("rose_gold_shovel", () -> new ShovelItem
            (MWToolTiers.ROSE_GOLD, 1.5F, -3.0F, new Item.Properties()));

    public static final RegistryObject<HoeItem> ROSE_GOLD_HOE = ITEMS.register("rose_gold_hoe", () -> new HoeItem
            (MWToolTiers.ROSE_GOLD, -2, -1.0F, new Item.Properties()));

    public static final RegistryObject<HorseArmorItem> ROSE_GOLD_HORSE_ARMOR = ITEMS.register("rose_gold_horse_armor", () -> new HorseArmorItem
            ( 8, "rose_gold", new Item.Properties().stacksTo(1)));

    public static final RegistryObject<ArmorItem> ROSE_GOLD_HELMET = ITEMS.register("rose_gold_helmet", () -> new ArmorItem
            (MWArmorMaterials.ROSE_GOLD, ArmorItem.Type.HELMET, new Item.Properties()));

    public static final RegistryObject<ArmorItem> ROSE_GOLD_CHESTPLATE = ITEMS.register("rose_gold_chestplate", () -> new ArmorItem
            (MWArmorMaterials.ROSE_GOLD, ArmorItem.Type.CHESTPLATE, new Item.Properties()));

    public static final RegistryObject<ArmorItem> ROSE_GOLD_LEGGINGS = ITEMS.register("rose_gold_leggings", () -> new ArmorItem
            (MWArmorMaterials.ROSE_GOLD, ArmorItem.Type.LEGGINGS, new Item.Properties()));

    public static final RegistryObject<ArmorItem> ROSE_GOLD_BOOTS = ITEMS.register("rose_gold_boots", () -> new ArmorItem
