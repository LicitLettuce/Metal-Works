    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (MWConfig.COMMON.populateVanillaTabs.get()) {
            if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
                ...
                event.getEntries().putAfter(MWItems.WAXED_ERODED_TIN.get().getDefaultInstance(), MWItems.TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.TIN_PLATE.get().getDefaultInstance(), MWItems.TARNISHED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.TARNISHED_TIN_PLATE.get().getDefaultInstance(), MWItems.CORRODED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.CORRODED_TIN_PLATE.get().getDefaultInstance(), MWItems.ERODED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.ERODED_TIN_PLATE.get().getDefaultInstance(), MWItems.WAXED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.WAXED_TIN_PLATE.get().getDefaultInstance(), MWItems.WAXED_TARNISHED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.WAXED_TARNISHED_TIN_PLATE.get().getDefaultInstance(), MWItems.WAXED_CORRODED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.WAXED_CORRODED_TIN_PLATE.get().getDefaultInstance(), MWItems.WAXED_ERODED_TIN_PLATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(MWItems.WAXED_ERODED_TIN_PLATE.get().getDefaultInstance(), MWItems.CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
