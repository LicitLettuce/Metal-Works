    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (ModConfig.COMMON.populateVanillaTabs.get()) {
            if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
                ...
                event.getEntries().putAfter(ModItems.TIN_BLOCK.get().getDefaultInstance(), ModItems.TARNISHED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN.get().getDefaultInstance(), ModItems.CORRODED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN.get().getDefaultInstance(), ModItems.ERODED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN.get().getDefaultInstance(), ModItems.WAXED_TIN_BLOCK.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_BLOCK.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN.get().getDefaultInstance(), ModItems.CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CHISELED_TIN.get().getDefaultInstance(), ModItems.TARNISHED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_CHISELED_TIN.get().getDefaultInstance(), ModItems.CORRODED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_CHISELED_TIN.get().getDefaultInstance(), ModItems.ERODED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_CHISELED_TIN.get().getDefaultInstance(), ModItems.WAXED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CHISELED_TIN.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_CHISELED_TIN.get().getDefaultInstance(), ModItems.WAXED_CORRODED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_CHISELED_TIN.get().getDefaultInstance(), ModItems.WAXED_ERODED_CHISELED_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_CHISELED_TIN.get().getDefaultInstance(), ModItems.TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_GRATE.get().getDefaultInstance(), ModItems.TARNISHED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_GRATE.get().getDefaultInstance(), ModItems.CORRODED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_GRATE.get().getDefaultInstance(), ModItems.ERODED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_GRATE.get().getDefaultInstance(), ModItems.WAXED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_GRATE.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_GRATE.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_GRATE.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_GRATE.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_GRATE.get().getDefaultInstance(), ModItems.TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.TARNISHED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.CORRODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.ERODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.WAXED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_GRATE_DRAIN.get().getDefaultInstance(), ModItems.CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CUT_TIN.get().getDefaultInstance(), ModItems.TARNISHED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_CUT_TIN.get().getDefaultInstance(), ModItems.CORRODED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_CUT_TIN.get().getDefaultInstance(), ModItems.ERODED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_CUT_TIN.get().getDefaultInstance(), ModItems.WAXED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CUT_TIN.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_CUT_TIN.get().getDefaultInstance(), ModItems.WAXED_CORRODED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_CUT_TIN.get().getDefaultInstance(), ModItems.WAXED_ERODED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_CUT_TIN.get().getDefaultInstance(), ModItems.CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.TARNISHED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.CORRODED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.ERODED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.WAXED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.WAXED_CORRODED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.WAXED_ERODED_CUT_TIN_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_CUT_TIN_STAIRS.get().getDefaultInstance(), ModItems.CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.TARNISHED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.CORRODED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.ERODED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.WAXED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.WAXED_CORRODED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.WAXED_ERODED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CUT_TIN.get().getDefaultInstance(), ModItems.TARNISHED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_CUT_TIN.get().getDefaultInstance(), ModItems.CORRODED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_CUT_TIN.get().getDefaultInstance(), ModItems.ERODED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_CUT_TIN.get().getDefaultInstance(), ModItems.WAXED_CUT_TIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                ...
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.WAXED_CORRODED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.WAXED_ERODED_CUT_TIN_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_CUT_TIN_SLAB.get().getDefaultInstance(), ModItems.TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_TILES.get().getDefaultInstance(), ModItems.TARNISHED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_TILES.get().getDefaultInstance(), ModItems.CORRODED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_TILES.get().getDefaultInstance(), ModItems.ERODED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_TILES.get().getDefaultInstance(), ModItems.WAXED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_TILES.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_TILES.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_TILES.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_TILES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_TILES.get().getDefaultInstance(), ModItems.TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.TARNISHED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.CORRODED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.ERODED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_TILE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_TILE_STAIRS.get().getDefaultInstance(), ModItems.TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.TARNISHED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.CORRODED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.ERODED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.WAXED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_TILE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_TILE_SLAB.get().getDefaultInstance(), ModItems.TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_SHINGLES.get().getDefaultInstance(), ModItems.TARNISHED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.CORRODED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.ERODED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.WAXED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_SHINGLES.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_SHINGLES.get().getDefaultInstance(), ModItems.TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.TARNISHED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.CORRODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.ERODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_SHINGLE_STAIRS.get().getDefaultInstance(), ModItems.TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.TARNISHED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.CORRODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.ERODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.WAXED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_SHINGLE_SLAB.get().getDefaultInstance(), ModItems.TIN_DOOR.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                ...
                event.getEntries().putAfter(ModItems.TIN_BARS.get().getDefaultInstance(), ModItems.TARNISHED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.TARNISHED_TIN_BARS.get().getDefaultInstance(), ModItems.CORRODED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.CORRODED_TIN_BARS.get().getDefaultInstance(), ModItems.ERODED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.ERODED_TIN_BARS.get().getDefaultInstance(), ModItems.WAXED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TIN_BARS.get().getDefaultInstance(), ModItems.WAXED_TARNISHED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_TARNISHED_TIN_BARS.get().getDefaultInstance(), ModItems.WAXED_CORRODED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_CORRODED_TIN_BARS.get().getDefaultInstance(), ModItems.WAXED_ERODED_TIN_BARS.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
                event.getEntries().putAfter(ModItems.WAXED_ERODED_TIN_BARS.get().getDefaultInstance(), ModItems.TIN_CHAIN.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
