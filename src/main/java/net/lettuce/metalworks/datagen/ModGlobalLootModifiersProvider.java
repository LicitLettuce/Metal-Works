...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    public ModGlobalLootModifiersProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
        super(output, lookupProvider, MetalWorks.MOD_ID);
    }
    ...
    protected void start() {
        ...
        add("tin_ingot_from_toolsmith", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(ResourceLocation.parse("minecraft:chests/village/village_toolsmith")).build(),
        ...
        add("tin_ingot_from_weaponsmith", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(ResourceLocation.parse("minecraft:chests/village/village_weaponsmith")).build(),
        ...
        add("tin_ingot_from_armorer", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(ResourceLocation.parse("minecraft:chests/village/village_armorer")).build(),
                LootItemRandomChanceCondition.randomChance(0.75f).build()
        }, ModItems.TIN_INGOT.get()));
        ...
        add("tin_ingot_from_mineshafts", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(ResourceLocation.parse("minecraft:chests/abandoned_mineshaft")).build(),
        ...
        add("rose_gold_horse_armor_from_fortresses", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(ResourceLocation.parse("minecraft:chests/nether_bridge")).build(),
                LootItemRandomChanceCondition.randomChance(0.4f).build()
