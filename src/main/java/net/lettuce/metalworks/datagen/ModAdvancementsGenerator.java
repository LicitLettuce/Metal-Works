...
public class ModAdvancementsGenerator implements AdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries,
        ...
        AdvancementHolder root = Advancement.Builder.advancement()
                .display(
                        ...
                        ResourceLocation.parse("metal_works:textures/gui/advancements/backgrounds/tarnished_tin.png"),
        ...
        // Pickle Ore
        AdvancementHolder rawTin = Advancement.Builder.advancement()
                .parent(root)
                .display(
        ...
        // From Ore to Ingot
        AdvancementHolder smeltTin = Advancement.Builder.advancement()
                .parent(rawTin)
                .display(
                        ModItems.TIN_INGOT.get(),
        ...
        AdvancementHolder tinBlock = Advancement.Builder.advancement()
                .parent(smeltTin)
                .display(
        ...
        // Preservation!
        AdvancementHolder waxedInInv = Advancement.Builder.advancement()
                .parent(tinBlock)
                .display(
                        Items.HONEYCOMB,
        ...
        // Foul Tarnish!
        AdvancementHolder weatheredInInv = Advancement.Builder.advancement()
                .parent(tinBlock)
                .display(
        ...
        // Not So Hardware
        AdvancementHolder tinArmorAny = Advancement.Builder.advancement()
                .parent(smeltTin)
                .display(
        ...
        // Not So Hardware
        AdvancementHolder tinToolsAny = Advancement.Builder.advancement()
                .parent(smeltTin)
                .display(
        ...
        // Curde Awakening
        AdvancementHolder crudeBronze = Advancement.Builder.advancement()
                .parent(root)
                .display(
        ...
        // The Bronze Age
        AdvancementHolder smeltBronze = Advancement.Builder.advancement()
                .parent(crudeBronze)
                .display(
                        ModItems.BRONZE_INGOT.get(),
        ...
        AdvancementHolder bronzeArmorAny = Advancement.Builder.advancement()
                .parent(smeltBronze)
                .display(
        ...
        // Metal Evolution
        AdvancementHolder bronzeToolAny = Advancement.Builder.advancement()
                .parent(smeltBronze)
                .display(
        ...
        // Aquarium Gravel
        AdvancementHolder crudeRoseGold = Advancement.Builder.advancement()
                .parent(root)
                .display(
        ...
        // Alchemist’s Alloy
        AdvancementHolder smeltRoseGold = Advancement.Builder.advancement()
        ...
        // A Touch of Elegance
        AdvancementHolder roseGoldArmorAny = Advancement.Builder.advancement()
        ...
        // Gilded Precision
        AdvancementHolder roseGoldToolAny = Advancement.Builder.advancement()
                .parent(smeltRoseGold)
                .display(
        ...
        // Arcane Ember
        AdvancementHolder obtainMagePowder = Advancement.Builder.advancement()
                .parent(smeltRoseGold)
                .display(
        ...
        // Wow, that's fast!
        AdvancementHolder craftRoseGoldPickaxe = Advancement.Builder.advancement()
                .parent(smeltRoseGold)
                .display(
        ...
        // Super Food
        AdvancementHolder roseGoldBeetroot = Advancement.Builder.advancement()
                .parent(smeltRoseGold)
                .display(
        ...
        // Arcane Protection
        AdvancementHolder summonMageGolem = Advancement.Builder.advancement()
                .parent(smeltRoseGold)
                .display(
        ...
        // Refined Radiance
        AdvancementHolder enchantedRoseGoldArmor = Advancement.Builder.advancement()
                ...
                .addCriterion("enchanted_rose_gold_helmet",
                        CriteriaTriggers.ENCHANTED_ITEM.createCriterion(new EnchantedItemTrigger.TriggerInstance(
                                Optional.empty(),
                                Optional.of(ItemPredicate.Builder.item().of(ModItems.ROSE_GOLD_HELMET.get()).build()),
                                MinMaxBounds.Ints.ANY))
                )
                .addCriterion("enchanted_rose_gold_chestplate",
                        CriteriaTriggers.ENCHANTED_ITEM.createCriterion(new EnchantedItemTrigger.TriggerInstance(
                                Optional.empty(),
                                Optional.of(ItemPredicate.Builder.item().of(ModItems.ROSE_GOLD_CHESTPLATE.get()).build()),
                                MinMaxBounds.Ints.ANY))
                )
                .addCriterion("enchanted_rose_gold_leggings",
                        CriteriaTriggers.ENCHANTED_ITEM.createCriterion(new EnchantedItemTrigger.TriggerInstance(
                                Optional.empty(),
                                Optional.of(ItemPredicate.Builder.item().of(ModItems.ROSE_GOLD_LEGGINGS.get()).build()),
                                MinMaxBounds.Ints.ANY))
                )
                .addCriterion("enchanted_rose_gold_boots",
                        CriteriaTriggers.ENCHANTED_ITEM.createCriterion(new EnchantedItemTrigger.TriggerInstance(
                                Optional.empty(),
                                Optional.of(ItemPredicate.Builder.item().of(ModItems.ROSE_GOLD_BOOTS.get()).build()),
                                MinMaxBounds.Ints.ANY))
                )
                .requirements(AdvancementRequirements.Strategy.OR)
