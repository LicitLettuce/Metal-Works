...
public class MageGolemModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount,
		...
		if (entity instanceof MageGolemEntity golem) {
			this.animate(golem.idleAnimationState, ModAnimationDefinitions.MAGE_GOLEM_IDLE, ageInTicks, 1f);
		}
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		mage_golem.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
